                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                                <b style="margin-right: 10px;">&#8369; 0 </b> <input id="ex1" data-slider-id='ex1Slider' type="text" data-slider-min="0" data-slider-max="100000" data-slider-step="10" data-slider-value="0"/> <b style="margin-left: 20px;">&#8369; 100,000 </b>
                            </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <label>Upload File</label>
                            <input type="file" name="barangaypermit" required>
                            <p class="help-block">Only png and jpg allowed</p>
                          </div>
                        </div>
                      </div>
