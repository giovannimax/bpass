		...
		<nav class = "navbar navbar-inverse navbar-fixed-top">
			<div class = "container-fluid">
				<div class = "navbar-header">
					...
					<p class = "navbar-text pull-right">BPASS Online Management System</p>
				</div>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<div class = "well col-lg-12">
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
					<?php
						$q_admin = $con->query("SELECT * FROM `admin`") or die(mysqli_error());
						while($f_admin = $q_admin->fetch_array()){
					?>	
						<tr>
							<td><?php echo $f_admin['Uname']?></td>
							<td><?php echo md5($f_admin['Pword'])?></td>
							<td><?php echo $f_admin['Fname']?></td>
							<td><?php echo $f_admin['Mname']?></td>
