      ...
      <div class="container">
        <div class="row">
          ...
          <tbody>
              <?php
              $i=1;
              $result= mysqli_query($con, "SELECT * FROM loan ORDER BY date DESC ") or die (mysqli_error());
          ...
          <tr>
            ...
            <td><a href="adminviewloan.php?id=<?php echo $row['LoanID'] ?>" class="btn btn-success" aria-hidden="true">View</a></td>
          </tr>
              <?php $i+=1; } ?>
          </tbody>
          </table>
