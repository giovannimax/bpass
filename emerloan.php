                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                               <b style="margin-right: 10px;">&#8369; 0 </b> <input id="ex1" data-slider-id='ex1Slider' type="text" data-slider-min="0" data-slider-max="30000" data-slider-step="10" data-slider-value="0"/> <b style="margin-left: 20px;">&#8369; 30,000 </b>
                            </div>
