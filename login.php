    ...
    <section id="main">
      <div class="container">
        <div class="row">
          ...
          <?php
            if(!empty($_GET)){
              echo '<div class="alert alert-warning" role="alert">You must login first.</div>';
            }
          ...
          ?>
            ...
            <form id="login" method="post" action="<?php $_SERVER['PHP_SELF']?>" class="well">
                  ...
                  <input type="submit" name="Login" action="<?php $_SERVER['PHP_SELF']?>"  class="btn btn-success form-control" value="Login"><br/><br/>
                    <a class="btn btn-primary btn-block" href="registration.php">Register Here!</a>
              </form>
